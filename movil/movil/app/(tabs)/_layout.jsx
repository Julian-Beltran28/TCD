...
//Pantallas que apareceran en el Layout de la app.
  ...
  return (
    <Tabs
      ...
      <Tabs.Screen
        ...
        options={{
          title: 'Perfil',
          tabBarIcon: ({ color }) => <IconSymbol size={28} name="card.fill" color={color} />,
        }}
      />
      ...
      <Tabs.Screen
        ...
        // Con estos Tabs, se ocultan las pantallas del Layout pero no cambia la funcionalidad.
