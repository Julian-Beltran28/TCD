...
export default function EditarProducto({ idSubcategoria }) {
    ...
    const obtenerProveedores = async () => {
        try {
            ...
            console.log('Proveedores raw:', response.data);
            const proveedoresArray = response.data.proveedores || response.data.data || response.data;
            console.log('Proveedores array:', proveedoresArray);
            setProveedor(Array.isArray(proveedoresArray) ? proveedoresArray : []);
        } catch (error) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            Swal.fire('Actualizado', 'El producto ha sido actualizado con éxito', 'success')
                .then(() => navigate(`/admin/Categoria/${idCategoria}`));
        } catch (error) {
