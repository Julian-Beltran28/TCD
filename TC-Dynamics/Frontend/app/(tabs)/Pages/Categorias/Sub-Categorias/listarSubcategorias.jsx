...
const Subcategorias = () => {
  ...
  }, [categoriaId, hideLoading, showLoading]);
  ...
  return (
    <View style={styles.container}>
      ...
      <TouchableOpacity
        ...
        onPress={() => navigateWithLoading({ pathname: '/(tabs)/Pages/Categorias/Sub-Categorias/registrarSubcategoria', params: { from: 'subcategorias', categoriaId: params.categoriaId, nombreCategoria: params.nombre } }, 'Navegando...', 500)}
      >
            ...
            <View style={styles.card}>
              ...
              <View style={styles.buttonRow}>
                <TouchableOpacity
                  ...
                  onPress={() => navigateWithLoading({ pathname: '/(tabs)/Pages/Categorias/Sub-Categorias/modificarSubcategoria', params: { id: item.id || item.ID || item.Id || item.id_subcategoria } }, 'Navegando...', 500)}
                >
                ...
                <TouchableOpacity
                  ...
                  onPress={() => navigateWithLoading({ pathname: '/(tabs)/Pages/Categorias/Sub-Categorias/Productos/listarProductos', params: { subcategoriaId: item.id || item.ID || item.Id || item.id_subcategoria, nombre: item.Nombre_Subcategoria || item.Nombre_subcategoria || item.nombre || item.Nombre } }, 'Navegando...', 500)}
                >
